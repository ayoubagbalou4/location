          ...
          <div className="col-xl-10 col-lg-11">
            <div className="d-flex justify-end">
              <button className="button h-50 px-24 -dark-1 bg-blue-1 text-white">
                Print
                <i className="icon-bed text-20 ml-10"></i>
              </button>
            </div>
            ...
            <div className="bg-white rounded-4 mt-50">
              <div className="layout-pt-lg layout-pb-lg px-50">
                ...
                <div className="row justify-between pt-50">
                  <div className="col-auto">
                    ...
                    <div className="text-15 text-light-1 mt-10">2301 Ravenswood Rd Madison,<br/> WI 53711</div>
                  </div>

                  <div className="col-xl-4">
                    <div className="text-20 fw-500">Customer</div>
                    <div className="text-15 fw-500 mt-20">John Doe</div>
                    <div className="text-15 text-light-1 mt-10">329 Queensberry Street, North Melbourne VIC 3051, Australia.</div>
                  </div>
                </div>
              ...
              <div className="border-top-light py-50">
                <div className="row x-gap-60 y-gap-10 justify-center">
                  <div className="col-auto">
                    <a href="#" className="text-14">www.gotirp.com</a>
                  </div>
                  <div className="col-auto">
                    <a href="#" className="text-14">invoice@gotrip.com</a>
                  </div>
                  <div className="col-auto">
                    <a href="#" className="text-14">(123) 123-456</a>
                  </div>
                </div>
              </div>
            </div>
